...
// ===== SECTION: RINGS DATA =====
const RINGS = [
  { id: 'FIRE_RING',     name: 'Fire Ring',     nameJa: '炎の指輪',     desc: 'Nullify lava & fire damage',           descJa: '溶岩・炎床のダメージを無効化',       cost: 400, symbol: '◎', color: '#ef4444' },
  { id: 'POISON_RING',   name: 'Poison Ring',   nameJa: '毒の指輪',     desc: 'Nullifies all poison swamp effects',   descJa: '毒沼の効果を完全に無効化する',           cost: 400, symbol: '◎', color: '#a855f7' },
  ...
  { id: 'KNOCKBACK_RING',name: 'Knockback Ring', nameJa: '突風の指輪',  desc: 'Attacks push enemies back 1 tile',     descJa: '攻撃で敵を1マス押し戻す',             cost: 1000, symbol: '◎', color: '#38bdf8' },
  { id: 'LIFE_RING',     name: 'Life Ring',     nameJa: '生命の指輪',   desc: 'Max HP +50%',                           descJa: '最大HPが50%上昇する',                     cost: 250, symbol: '◎', color: '#4ade80' },
  { id: 'TOUGH_RING',    name: 'Tough Ring',    nameJa: '堅守の指輪',   desc: 'Reduces all damage taken by 25%',       descJa: '被ダメージを25%軽減する',          cost: 350, symbol: '◎', color: '#94a3b8' },
  { id: 'BREAKER_RING',  name: 'Breaker Ring',  nameJa: '壁壊しの指輪', desc: 'Break 1 wall when stamina is full (costs all stamina)', descJa: 'スタミナ満タン時に壁を1マス破壊(スタミナ全消費)', cost: 200, symbol: '◎', color: '#d97706' },
  { id: 'BOMB_RING',     name: 'Bomb Ring',     nameJa: '爆弾の指輪',   desc: 'Place bombs instead of blocks (explode in 5 turns)', descJa: 'ブロックの代わりに爆弾を設置(5ターンで爆発)', cost: 200, symbol: '◎', color: '#fb923c' },
  { id: 'STEALTH_RING',    name: 'Stealth Ring',    nameJa: '隠密の指輪',   desc: 'Reduces enemy detection range (8 -> 5)',                    descJa: '敵の探知範囲を狭める(8→5)',                      cost: 350, symbol: '◎', color: '#8b5cf6' },
  { id: 'ICE_BLOCK_RING',  name: 'Ice Block Ring',  nameJa: '氷塊の指輪',   desc: 'Place ice blocks that slide when attacked',                 descJa: '攻撃で滑る氷ブロックを設置',                         cost: 200, symbol: '◎', color: '#7dd3fc' },
  { id: 'STAR_RING',       name: 'Star Ring',       nameJa: '星の指輪',     desc: 'Place star blocks that shoot flames when attacked',         descJa: '攻撃で星を発射する星ブロックを設置',                  cost: 200, symbol: '◎', color: '#fde047' },
  { id: 'GOLEM_RING',     name: 'Golem Ring',      nameJa: 'ゴーレムの指輪', desc: 'At full stamina, attacks knock back enemies (Golem Smash!)', descJa: 'スタミナ満タン時の攻撃で敵を強制的に押し飛ばす',       cost: 1500, symbol: '◎', color: '#a8a29e' },
  { id: 'NECRO_RING',     name: 'Necro Ring',      nameJa: '死者活性の指輪', desc: 'Enemies you defeat are revived as your allies',              descJa: '倒した敵が仲間として蘇る',                             cost: 1500, symbol: '◎', color: '#7c3aed' },
  { id: 'RED_TEAR_RING', name: 'Red Tear Ring',   nameJa: '赤涙の指輪',   desc: 'HP below 20%: attack power x5',        descJa: 'HP20%未満で攻撃力が5倍になる',       cost: 200, symbol: '◎', color: '#dc2626' },
];

// 二重装備時の追加効果説明（指輪セレクト画面で2個目装備時に表示）
const RING_DOUBLED_DESC = {
    FIRE_RING:      { ja: '攻撃に炎ダメージを追加（+floor/4+2）',           en: 'Attacks deal bonus fire damage' },
    POISON_RING:    { ja: '攻撃に毒ダメ追加 + 敵を5ターン鈍化',               en: 'Poison damage + slow enemy for 5 turns' },
    CRITICAL_RING:  { ja: '会心率 20% → 40%',                                en: 'Critical rate 20% → 40%' },
    STAMINA_RING:   { ja: '攻撃時のスタミナ消費 12 → 6',                      en: 'Attack stamina cost 12 → 6' },
    KNOCKBACK_RING: { ja: '敵を 1マス → 2マス 押し戻す',                      en: 'Push enemies 2 tiles instead of 1' },
    ...
    BOMB_RING:      { ja: '爆発範囲が十字5マスずつ延長（ボンバーマン風）',        en: 'Blast extends 5 tiles in each cardinal direction' },
    STEALTH_RING:   { ja: '敵の探知範囲 5 → 3',                              en: 'Enemy detection range 5 → 3' },
    ...
    RED_TEAR_RING:  { ja: '発動閾値 HP20% → HP40% 未満に拡大',                en: 'Activation threshold HP20% → HP40%' },
};
...
const FIXED_STAGES = [
    ...
    { floor: 7,   title: 'HOWLING GALE (WIND)',           suppressWind: true },
    ...
    { floor: 27,  title: 'HALL OF FORGERIES (MIMICS)' },
    { floor: 29,  title: 'SEALED CHAMBER II' },
    { floor: 30,  title: 'GRAND FORGERY (MIMICS)' },
    { floor: 33,  title: 'FACTION RUINS (WIND)',           suppressWind: true },
    { floor: 35,  title: 'FROZEN CAVERN',                  suppressWind: true },
    { floor: 36,  title: 'THE GALE GRINDER',               suppressWind: true },
    { floor: 38,  title: 'TEMPEST CROSSING' },
    { floor: 40,  title: 'SPECIAL LAYOUT',                 suppressWind: true },
    { floor: 43,  title: 'POISON MARSH' },
    { floor: 45,  title: 'VIOLENT GALES' },
    { floor: 47,  title: 'TURRET VAULT (BOMBS)' },
    { floor: 48,  title: "MIMIC'S GALLERY" },
    { floor: 50,  title: 'BOSS: THE KING',                 suppressWind: true },
    { floor: 53,  title: 'LAVA SHRINE' },
    { floor: 55,  title: 'SCROLL WALLS (MULTI)',           suppressWind: true },
    { floor: 57,  title: 'GLACIAL BATTERY' },
    { floor: 63,  title: 'POISON WASTES' },
    { floor: 65,  title: 'SCROLL WALLS (MULTI)',           suppressWind: true },
    { floor: 66,  title: "BREAKER'S DEN",                   suppressWind: true },
    { floor: 70,  title: "HOPPER'S GAUNTLET" },
    { floor: 73,  title: 'THE ROCKFALL',                   suppressWind: true },
    { floor: 75,  title: 'THE VOID ARENA',                 suppressWind: true },
    { floor: 77,  title: 'FORBIDDEN LABYRINTH' },
    { floor: 78,  title: 'FACTION WAR (KILLING FIELDS)' },
    { floor: 80,  title: 'FROZEN FURNACE',                 suppressWind: true },
    { floor: 83,  title: "THIEF'S LABYRINTH" },
    { floor: 85,  title: 'THE WRECKING STORM' },
    { floor: 88,  title: 'BOSS: SUMMONER',                 suppressWind: true },
    { floor: 91,  title: 'STONE TEMPEST (MULTI)',          suppressWind: true },
    { floor: 95,  title: 'FACTION BATTLEFIELD' },
    { floor: 99,  title: 'THE FINAL CAVERN' },
    { floor: 100, title: 'BOSS: DRAGON CORE',              suppressWind: true }
];
...
function updateUI() {
    ...
    if (floorLevel === 100) {
        ...
        floorElement.innerText = `DEEP ${formatFloor(floorLevel)} [${currentScreen.x},${currentScreen.y}]`;
...
function initMap() {
    ...
    const fixedStageFloors = [50, 53, 55, 57, 63, 65, 66, 70, 73, 75, 77, 78, 80, 83, 85, 86, 88, 91, 93, 99, 100];
    if ((floorLevel >= 50 && floorLevel < 100 && !fixedStageFloors.includes(floorLevel)) || floorLevel >= 101) {
        ...
        function generateBizarreScreen(sx, sy) {
            ...
            const bizType = _bRoll < 0.08  ? 'FACTION_WAR'   // 8% (派閥戦 — 低確率レア)
                          : _bRoll < 0.085 ? 'FLEEING_HORDE'
                          : _bRoll < 0.090 ? 'CIRCLE_SIEGE'
                          : _bRoll < 0.095 ? 'KINGS_COURT'
            ...
            // ---- FACTION_WAR: 二派閥の激戦区（ランダム構成） ----
                ...
                // 敵スタット計算ヘルパー
                const fwEnemyStats = (type) => {
                    if (type==='ORC')     return { hp:40+floorLevel*5,   exp:40 };
                    if (type==='BREAKER') return { hp:50+floorLevel*4,   exp:45 };
                    if (type==='BLAZE')   return { hp:15+floorLevel*2,   exp:15 };
                    if (type==='FROST')   return { hp:15+floorLevel*2,   exp:15 };
                    if (type==='LAYER')   return { hp:20+floorLevel*2,   exp:25 };
                    if (type==='TURRET')  return { hp:100+floorLevel*5,  exp:40 };
                    return                       { hp:3+floorLevel,      exp:5  }; // NORMAL
                };

                // 派閥ごとにランダムな敵タイプを選択（互いに異なる構成）
                const fwAllTypes = ['NORMAL','NORMAL','ORC','BLAZE','FROST','BREAKER','LAYER','NORMAL','ORC','BLAZE'];
                const fwShuffled = fwAllTypes.slice().sort(() => Math.random() - 0.5);
                // CRIMSON: シャッフル前半から2〜3種
                const fwCTypes = [...new Set(fwShuffled.slice(0, 3))];
                // COBALT: シャッフル後半から2〜3種（重複を避ける）
                const fwCBTypes = [...new Set(fwShuffled.slice(3, 6))].filter(t => !fwCTypes.includes(t));
                if (fwCBTypes.length === 0) fwCBTypes.push('NORMAL');

                // 各派閥の敵を配置（8〜13体）
                const fwPlaceEnemies = (faction, typePool, xBias) => {
                    const count = 8 + Math.floor(Math.random() * 6);
                    for (let i = 0; i < count; i++) {
                        for (let t = 0; t < 100; t++) {
                            const ex = Math.random() < 0.65 ? xBias() : Math.floor(Math.random()*(COLS-4))+2;
                            const ey = Math.floor(Math.random()*(ROWS-4))+2;
                            if (sMap[ey][ex] === SYMBOLS.FLOOR && !sEnemies.some(e=>e.x===ex&&e.y===ey)) {
                                const type = typePool[Math.floor(Math.random()*typePool.length)];
                                const { hp, exp } = fwEnemyStats(type);
                                const eObj = { type, x:ex, y:ey, hp, maxHp:hp, flashUntil:0, offsetX:0, offsetY:0, expValue:exp, stunTurns:0, faction };
                                if (type==='TURRET') { eObj.dir=0; eObj.hopTimer=1+Math.floor(Math.random()*3); }
                                sEnemies.push(eObj);
                                break;
                            }
                        }
                ...
                fwPlaceEnemies('CRIMSON', fwCTypes,  () => Math.floor(Math.random()*(fwMidX-2))+2);
                fwPlaceEnemies('COBALT',  fwCBTypes, () => Math.floor(Math.random()*(COLS-fwMidX-2))+fwMidX);
                // 各派閥にLAYERを1体追加
                const fwAddLayer = (faction, xBias) => {
                    for (let t = 0; t < 100; t++) {
                        const ex = Math.random() < 0.65 ? xBias() : Math.floor(Math.random()*(COLS-4))+2;
                        const ey = Math.floor(Math.random()*(ROWS-4))+2;
                        if (sMap[ey][ex] === SYMBOLS.FLOOR && !sEnemies.some(se=>se.x===ex&&se.y===ey)) {
                            const { hp, exp } = fwEnemyStats('LAYER');
                            sEnemies.push({ type:'LAYER', x:ex, y:ey, hp, maxHp:hp, flashUntil:0, offsetX:0, offsetY:0, expValue:exp, stunTurns:0, faction });
                            break;
                        }
                    }
                };
                fwAddLayer('CRIMSON', () => Math.floor(Math.random()*(fwMidX-2))+2);
                fwAddLayer('COBALT',  () => Math.floor(Math.random()*(COLS-fwMidX-2))+fwMidX);
                // 各派閥のORCを1体削除
                for (const fw of ['CRIMSON', 'COBALT']) {
                    const idx = sEnemies.findIndex(se => se.type === 'ORC' && se.faction === fw);
                    if (idx !== -1) sEnemies.splice(idx, 1);
                }
        ...
        keyMap[keyRoom.cy][keyRoom.cx] = SYMBOLS.KEY;
            ...
            for (let sy = 0; sy < screenGridSize; sy++) {
                for (let sx = 0; sx < screenGridSize; sx++) {
                    ...
                    for (const e of sEnemies) {
                        if (e.type === 'TURRET') continue; // TURRETは固定砲台なので除外
        ...
        const doorRoom = doorRooms[Math.floor(Math.random() * doorRooms.length)];
        ...
        // マルチスクリーンにスポーンブロックを1体配置（スタート画面は除外）
        {
            ...
            const tryPlaceSpawner = (pick) => {
                ...
                const isGood = (x, y) => {
                    ...
                    const t = spMap[y][x];
                    if (t === SYMBOLS.KEY || t === SYMBOLS.DOOR || t === SYMBOLS.STAIRS) return false;
        ...
        // 深層: 派閥戦争フロア（約15%）
        if (floorLevel >= 101 && !(deepTheme && deepTheme.isSanctuaryFloor) && Math.random() < 0.05) {
            for (let sy = 0; sy < screenGridSize; sy++) {
                for (let sx = 0; sx < screenGridSize; sx++) {
                    if (sx === 0 && sy === 0) continue; // スタート画面は除外
                    for (const e of screenGrid.enemies[sy][sx]) {
                        if (e.type === 'TURRET') continue;
                        e.faction = e.x < Math.floor(COLS / 2) ? 'CRIMSON' : 'COBALT';
                    }
                }
            }
            addLog("⚔️ Faction War echoes through the depths...");
        }
    ...
    if (floorLevel === 29) {
        addLog("EVENT: The Sealed Chamber.");
        addLog("Enemies are buried in the walls. A Breaker will free them.");
        ...
        if (exitX == null) { exitX = COLS - 4; exitY = ROWS - 4; }
        map[exitY][exitX] = SYMBOLS.STAIRS;

        // 壁の中に孤立した1マス空間を見つけるヘルパー
        const findTrappedCell29 = (minDist) => {
            for (let t = 0; t < 100; t++) {
                const cx = Math.floor(Math.random() * (COLS - 6)) + 3;
                const cy = Math.floor(Math.random() * (ROWS - 6)) + 3;
        ...
        // BREAKER: 出口の隣に1匹（確定）
        const exitBx = exitX - 1 >= 1 ? exitX - 1 : exitX + 1;
        map[exitY][exitBx] = SYMBOLS.FLOOR;
        enemies.push({
            type: 'BREAKER', x: exitBx, y: exitY,
            hp: 50 + floorLevel * 4, maxHp: 50 + floorLevel * 4,
            flashUntil: 0, offsetX: 0, offsetY: 0, expValue: 45, stunTurns: 0
        });
    ...
    if (floorLevel === 50) {
        ...
        map[1][COLS - 2] = f50Tomes[Math.floor(Math.random() * f50Tomes.length)]; // 右上隅にランダム魔導書

        // スポーンブロック（N）: 右上の魔導書(COLS-2,1)付近に確定配置
        // 10ターンに1体のE(NORMAL)を生成する
        {
            const spHp = 50 + floorLevel * 4;
            const candidates = [
                { x: COLS - 3, y: 2 },
    ...
    if (floorLevel === 47) {
        ...
        addLog("Cannons are buried in the walls. A Breaker will wake them all.");
    ...
    if (floorLevel === 78) {
        ...
        // ランダム地形（5種）
        const f78Layout = Math.floor(Math.random() * 5); // 0=迷路, 1=要塞, 2=十字, 3=多部屋, 4=環状
    ...
    if (floorLevel >= 10 && !isWindFloor && !fixedStages.includes(floorLevel) && Math.random() < windChance) {
        isWindFloor = true;
        windTimer = 4; // 1ターン目で即発動
    ...
    for (let i = 1; i < rooms.length; i++) {
        ...
        // いかれたG: 20階以降、2%の確率でランダムな部屋に出現（強さ=プレイヤーと同等）
        if (floorLevel >= 20 && Math.random() < 0.02) {
...
async function startFloorTransition() {
    ...
    // 仲間を次のフロアに連れていく（固定砲台・ブロック・擬態・特殊敵・蜘蛛は除外）
    const _excludedCarryTypes = new Set(['TURRET', 'HOPPER_TURRET', 'SPAWNER', 'SPIDER', 'MIMIC', 'FAIRY_MIMIC', 'MADMAN', 'KEY_RUNNER', 'DRAGON', 'SUMMONER', 'KING']);
    const _carriedAllies = enemies
        .filter(e => e.isAlly && e.hp > 0 && !e._dead && !_excludedCarryTypes.has(e.type))
        .map(e => ({ ...e, body: undefined, offsetX: 0, offsetY: 0, flashUntil: 0 }));
    transition.active = true;
    transition.mode = 'FALLING';
    transition.text = `FLOOR ${formatFloor(floorLevel)}`;
...
function gameLoop(now) {
    const hideStates = ['TITLE', 'FIXED_STAGE_SELECT', 'OPENING', 'GAMEOVER', 'GAMEOVER_SEQ', 'ENDING', 'ENDING_SEQ'];
...
function drawTitle() {
    ...
    const menuY = canvas.height / 2 + (testModeVisible ? -30 : 30);
    ...
    const allOptions = [...baseOptions, 'TEST PLAY', 'DEEP TEST', 'FIXED STAGE'];
    ...
    options.forEach((opt, i) => {
        ...
        if (isSelected) {
            ...
            if (i === 1 && !hasSave) {
                ...
                ctx.fillStyle = '#aaa';
                ctx.fillText(`— Resume from B${formatFloor(saveFloor)}F —`, canvas.width / 2, menuY + i * 40 + 25);
                ctx.font = '24px Courier New';
                ctx.fillStyle = '#ededed';
            } else if (isDescend) {
                ctx.font = '12px Courier New';
            ...
            if (i === fixedSelectIdx) {
                ctx.font = '12px Courier New';
                ctx.fillStyle = '#f97316';
                ctx.fillText('Press [Enter] to pick a featured stage', canvas.width / 2, menuY + i * 40 + 25);
                ctx.font = '24px Courier New';
            }
        }
    ...
    if (testModeVisible) {
        ctx.font = '11px Courier New';
        ctx.fillStyle = '#f97316';
        ctx.fillText('[TEST MODE]', canvas.width / 2, menuY + allOptions.length * 40 - 25);
    }
...
function drawFixedStageSelect() {
    ...
    ctx.fillText('FIXED STAGE SELECT', canvas.width / 2, 60);

    ctx.font = '12px Courier New';
    ctx.fillStyle = '#f97316';
    ctx.fillText('[TEST MODE]', canvas.width / 2, 82);
    ...
    for (let i = from; i < to; i++) {
        ...
        ctx.fillStyle = isSelected ? '#ededed' : '#666';
        const floorStr = String(s.floor).padStart(3, ' ');
        const cursor = isSelected ? '> ' : '  ';
        ctx.fillText(`${cursor}B${floorStr}F   ${s.title}`, canvas.width / 2 - 180, y);
    }
    ...
    ctx.font = '11px Courier New';
    ctx.fillStyle = '#555';
    if (from > 0) ctx.fillText('▲ more', canvas.width / 2, listTop - 12);
    if (to < total) ctx.fillText('▼ more', canvas.width / 2, listTop + visibleRows * rowH + 4);

    ctx.fillStyle = '#444';
    ctx.font = '13px Courier New';
    ctx.fillText('[Up/Down] Select   [Enter] Play   [Esc] Back', canvas.width / 2, canvas.height - 20);
}
...
function drawStatusScreen() {
    ...
    if (statusPage === 0) {
        ...
        main.forEach(s => {
            ...
            if (s.label === 'ATTACK') {
                ...
                if (hasRingDoubled('FIRE_RING')) {
                    const fireBonus = Math.max(2, Math.floor(floorLevel / 4) + 2);
        ...
        ctx.lineWidth = 1;
        ctx.beginPath(); ctx.moveTo(sx, y - 8); ctx.lineTo(WX + WW - 20, y - 8); ctx.stroke();
        ...
        // ── Page 2: Equipment ──────────────────────────────────
        const equip = [
            { symbol: SYMBOLS.SWORD,  name: 'Holy Sword',  level: player.swordCount,  desc: `攻撃力 +${player.swordCount * 3}` },
            { symbol: SYMBOLS.ARMOR,  name: 'Holy Armor',  level: player.armorCount,  desc: `防御力 +${player.armorCount}` },
        ];
        if (player.fairyCount > 0) {
            equip.push({ symbol: SYMBOLS.FAIRY, name: 'Fairy', level: null, desc: `x${player.fairyCount}` });
        }
        ...
        equip.forEach(e => {
            ...
            ctx.fillStyle = '#ededed';
            ctx.font = '14px Courier New';
            ctx.fillText(e.symbol + '  ' + e.name, sx, y);
            ctx.fillStyle = '#777';
            ctx.font = '12px Courier New';
...
function getPlayerAttack() {
    ...
    if (hasRing('RED_TEAR_RING')) {
        const threshold = hasRingDoubled('RED_TEAR_RING') ? 0.4 : 0.2;
...
function drawRingsScreen() {
    ...
    if (ringEquipPhase === 'SLOT') {
        ...
        visItems.forEach((item, vi) => {
            ...
            // スロット装備表示: 両スロットに同じ指輪が入っていれば "Slot 1+2" (二重装備強調)
    ...
    if (gameState === 'ENDING_SEQ' && transition.active) {
        ...
        enemies.forEach(e => {
            ...
            const isFlashing = now < e.flashUntil
                || (e.stunTurns > 0 && Math.floor(now / 150) % 2 === 0)
...
async function advanceScrollWalls() {
    ...
    const WALL_FIXED = (floorLevel === 91)
        ? new Set(['HOPPER_TURRET', 'SPAWNER'])
        : new Set(['TURRET', 'HOPPER_TURRET', 'SPAWNER']);
...
async function handleAction(dx, dy) {
    ...
    if (map[player.y][player.x] === SYMBOLS.WEB) {
    ...
    if (nx < 0 || nx >= COLS || ny < 0 || ny >= ROWS) {
        ...
        if (multiScreenMode) {
            ...
            if (canTransition) {
                ...
                // 固定砲台・ブロック・擬態系・蜘蛛は連れていかず、その場に残す
                const _msExcludedCarry = new Set(['TURRET', 'HOPPER_TURRET', 'SPAWNER', 'SPIDER', 'MIMIC', 'FAIRY_MIMIC', 'MADMAN', 'KEY_RUNNER', 'DRAGON', 'SUMMONER', 'KING']);
                const leavingAllies = enemies.filter(e => e.isAlly && !_msExcludedCarry.has(e.type));
                leavingAllies.forEach(a => travelingAllies.push({ ...a }));
                enemies = enemies.filter(e => e.type !== 'MADMAN' && !(e.isAlly && !_msExcludedCarry.has(e.type)));
    ...
    if (victim && victim.isAlly) {
        // 味方とは攻撃せず位置を入れ替える（タレットも含めて）
        ...
        if (map[ny][nx] === SYMBOLS.MERCHANT && !(merchantState && merchantState.dyingUntil)) {
            ...
            if (shopStock.length === 0) {
                ...
                // 後半ほど価格が高くなる（50F以降2倍、75F以降3倍）
                const priceMult = floorLevel >= 75 ? 3 : floorLevel >= 50 ? 2 : 1;
                const ringItems = shuffled.slice(0, 3).map(i => ({ type: 'ring', ringIndex: i, cost: Math.floor(RINGS[i].cost * priceMult) }));
                // 武器・防具の価格: 10Fは100G固定、他の階はランダム（後半高額化）
        ...
        if (isBlockedByWall && !player.isBreaker && hasRing('BREAKER_RING') && player.stamina >= 100 && ny >= 1 && ny < ROWS - 1 && nx >= 1 && nx < COLS - 1) {
            ...
            if (hasRingDoubled('BREAKER_RING')) {
                ...
                // (2) 半径4マス内からランダム3ターゲット（周囲2マスは既に壊したので半径3-4帯が実質対象）
                const radius = 4;
                ...
                if (nextTile === SYMBOLS.WAND) {
                    ...
                    if (ringDrop) {
                        ...
                        if (ringData && !player.ownedRings.includes(ringData.id)) {
                            ...
                            addLog(`💍 Found a ${ringData.name}, but already owned. Randomly gained a ${randomRing.name} ×${newCount}!`);
...
async function attackEnemy(enemy, dx, dy, isMain = true) {
    ...
    let isCritical = Math.random() < (hasRingDoubled('CRITICAL_RING') ? 0.40 : hasRing('CRITICAL_RING') ? 0.20 : 0.10); // かいしんの一撃
    ...
    // FIRE_RING 二重装備: 攻撃に炎ダメージを上乗せ（GOLD以外）
    ...
    if (hasRing('KNOCKBACK_RING') && enemy.hp > 0 && enemy.type !== 'TURRET' && enemy.type !== 'HOPPER_TURRET' && enemy.type !== 'SNAKE' && enemy.type !== 'DRAGON' && enemy.type !== 'SUMMONER') {
        ...
        if (_kbFullStamina || enemy.type !== 'ORC') {
            // 二重装備なら2マス押し、通常は1マス押し
            const kbSteps = hasRingDoubled('KNOCKBACK_RING') ? 2 : 1;
            for (let step = 0; step < kbSteps && enemy.hp > 0 && !enemy._dead; step++) {
                ...
                if (_kbFullStamina && isRealHole(kbx, kby)) {
                    ...
                    enemy.x = kbx;
                    enemy.y = kby;
                    spawnFloatingText(kbx, kby, step === kbSteps - 1 ? "KNOCKBACK!" : "!", "#38bdf8");
                    SOUNDS.HIT();
                    draw();
                    await new Promise(r => setTimeout(r, 120));
                } else {
                    // 移動先がブロックされている: 壁・ブロックなら停止、敵なら飛び越える
                    if (kbx < 0 || kbx >= COLS || kby < 0 || kby >= ROWS) break;
                    if (isWallAt(kbx, kby)) break;
                    // 敵が塞いでいる → その上を飛び越えて空きマスまでジャンプ
                    let jumpX = kbx + dx, jumpY = kby + dy;
                    let landing = null;
                    for (let j = 0; j < 10; j++) {
                        if (jumpX < 0 || jumpX >= COLS || jumpY < 0 || jumpY >= ROWS) break;
                        if (isWallAt(jumpX, jumpY)) break;
                        if (canEnemyMove(jumpX, jumpY, enemy)) {
                            landing = { x: jumpX, y: jumpY };
                            break;
                        }
                        jumpX += dx; jumpY += dy;
                    }
                    if (!landing) break; // 飛び越えた先に空きマスなし
                    spawnFloatingText(enemy.x, enemy.y, "KNOCKBACK!", "#38bdf8");
                    SOUNDS.HIT();
                    // 1マスずつジャンプアニメーション（敵の上を通過、オフセットで跳ねて見せる）
                    while (enemy.x !== landing.x || enemy.y !== landing.y) {
                        enemy.x += dx; enemy.y += dy;
                        enemy.offsetY = -8; // 少し浮かせる
                        draw();
                        await new Promise(r => setTimeout(r, 90));
                        enemy.offsetY = 0;
                    }
                    spawnFloatingText(enemy.x, enemy.y, step === kbSteps - 1 ? "KNOCKBACK!" : "!", "#38bdf8");
                    // 着地先が穴なら落下
                    if (_kbFullStamina && isRealHole(enemy.x, enemy.y)) {
                        scheduleEnemyFall(enemy, `Knocked ${enemy.type} into the hole!`, true);
                        break;
                    }
                }
    ...
    if (hasRing('GOLEM_RING') && enemy.hp > 0 && (_staminaBeforeAttack >= 100 || hasRingDoubled('GOLEM_RING'))) {
...
async function enemyTurn() {
    ...
    for (let i = enemies.length - 1; i >= 0; i--) {
        ...
        // 蜘蛛の巣の上にいる敵は5ターン動けない（蜘蛛本体は自分の巣に免疫）
        // 別の巣マスに移動したら再捕獲（位置をトラッキング）
        if (e.type !== 'SPIDER' && map[e.y] && map[e.y][e.x] === SYMBOLS.WEB) {
        ...
        if (e.type === 'SPIDER') {
            ...
            for (const d of adj4) {
                ...
                if (target) {
                    ...
                    if (target.hp <= 0) {
                        ...
                        e.offsetX = 0;
                        e.offsetY = 0;
                        if (map[oldY] && map[oldY][oldX] === SYMBOLS.FLOOR) {
                            map[oldY][oldX] = SYMBOLS.WEB;
                        }
                        draw(performance.now());
                    } else {
                        // 仕留め損なった: 元の位置へ素早く戻る
            ...
            if (!e.isAlly && !e._dead) {
                // (1) プレイヤーが巣に捕まっている → プレイヤーへ接近
                if (player.webStuckTurns > 0) {
                    const distP = Math.abs(player.x - e.x) + Math.abs(player.y - e.y);
                    if (distP > 1) moveSpiderTo(player.x, player.y);
                } else {
                    // (2) 獲物がもう近くに居なければ初期位置へ帰巣
                    const huntRange = 8;
                    const distPlayer = Math.abs(player.x - e.x) + Math.abs(player.y - e.y);
                    const hasNearbyPrey = enemies.some(o =>
                        o !== e && !o._dead && o.hp > 0 &&
                        o.type !== 'SPIDER' && !o.isAlly &&
                        Math.abs(o.x - e.x) + Math.abs(o.y - e.y) <= huntRange);
                    const hasNearbyPlayer = !player.isStealth && distPlayer <= huntRange;
                    if (!hasNearbyPrey && !hasNearbyPlayer && e.homeX !== undefined &&
                        (e.x !== e.homeX || e.y !== e.homeY)) {
                        moveSpiderTo(e.homeX, e.homeY);
                    }
                }
            }
            // 巣を増殖（敵味方を問わず）: 隣接床マスへ低確率で拡張
            if (Math.random() < 0.08) {
                const shuffled = adj4.slice().sort(() => Math.random() - 0.5);
                for (const d of shuffled) {
                    const wx = e.x + d.x, wy = e.y + d.y;
        ...
        const _staticTypes = ['TURRET','HOPPER_TURRET','SPAWNER','DRAGON','KING','CORE','MIMIC','FAIRY_MIMIC','SNAKE'];
        if (!_staticTypes.includes(e.type) && Math.random() < 0.03) {
        ...
        if (e.faction && !e.isAlly && (!_isWoH || _lastOppSurvivor)) {
            ...
            if (hostilePlayer) {
                ...
                if (dPlayer <= 1 && !player.isStealth) {
                    ...
                    if (player.hp > 0) animateBounce(player);
                    spawnDamageText(player.x, player.y, dmg, e.faction === 'CRIMSON' ? '#4ade80' : '#a855f7');
                    await _w(80);
        ...
        if (e.flee && !e.isAlly) {
            ...
            if (fDist > 1 || e.type === 'KEY_RUNNER' || e.type === 'GOLD') {
                // 逃走方向をスコアリングで選択：
                ...
                if (chosen) {
                    ...
                    // KEY_RUNNER / GOLD: 2歩目
                    if (e.type === 'KEY_RUNNER' || e.type === 'GOLD') {
            ...
            if (e.type === 'KEY_RUNNER' || e.type === 'GOLD') continue; // 反撃しない
        }
        ...
        // スポーンブロックAI: 10ターンに1体のE(NORMAL)を隣接マスに生成
        // isAlly=trueの場合は味方E(NORMAL)を生成する
        if (e.type === 'SPAWNER') {
            ...
            if (e.spawnCooldown <= 0) {
                ...
                for (const d of dirs) {
                    ...
                    if (SOUNDS.SUMMON) SOUNDS.SUMMON();
                    break;
                }
                e.spawnCooldown = 10;
            }
        ...
        if (e.type === 'HEALER') {
            ...
            if (healedAny) {
                ...
                if (SOUNDS.HEAL_SOFT) SOUNDS.HEAL_SOFT();
            }
        ...
        if (e.isAlly) {
            ...
            if (allyBestTarget && allyMinDist <= 8 && !shouldFollowPlayer) {
                ...
                if (allyMinDist === 1) {
                    ...
                    const tryMoveAlly = e.type === 'BREAKER' ? allyBreakerTryMove
                        : (nx, ny) => {
                            if (isRealHole(nx, ny)) return false;
                ...
                if (dP > 1) { // 隣接していなければ近づく
                    ...
                    const findAllyTurretAt2 = (nx, ny) => enemies.find(oe =>
                        ...
                        oe.x === nx && oe.y === ny && oe.isAlly &&
                        (oe.type === 'TURRET' || oe.type === 'HOPPER_TURRET'));
                    // 味方BREAKERは壁を壊して進む（穴は避ける、味方タレットとは入れ替わる）
                    ...
                    // 通常味方: 穴回避 + 味方タレットは通り抜け可（位置入れ替え）
                    const tryFollowMove = e.type === 'BREAKER' ? allyBreakerFollow
                        : (nx, ny) => {
                            if (isRealHole(nx, ny)) return false;
        ...
        enemies.filter(ally => ally.isAlly && !(ally._reviveStationary > 0))
            .forEach(ally => targets.push({ x: ally.x, y: ally.y, isAlly: true, obj: ally }));

        // SPIDER は無派閥の嫌われ者: 全員から襲われる（距離無制限、画面全域から集まる）
        ...
        const detectRange = (e.type !== 'ORC' && hasRingDoubled('STEALTH_RING')) ? 3
            : (e.type !== 'ORC' && hasRing('STEALTH_RING')) ? 5
            : baseDetect;
...
function fireStarLaser(fromX, fromY, dx, dy) {
    ...
    for (const e of hitList) {
        ...
        if (e.type === 'DRAGON') dmg = dragonFireResist(dmg);
        e.hp -= dmg;
        e.flashUntil = performance.now() + 200;
...
function canEnemyMove(x, y, mover = null) {
    ...
    if (isObstacle) {
        if (tile === SYMBOLS.LAVA && mover && (mover.type === 'BLAZE' || mover.type === 'ORC' || mover.type === 'KEY_RUNNER' || mover.type === 'BREAKER')) {
            // 移動を許可
        } else {
            return false;
        }
...
// 最下層（DEEP_ENDING_FLOOR = MAX_SAFE_INTEGER）に直接テストプレイジャンプ
// コンソールで `debugBottomFloor()` と入力すると、その階から開始（テストモード、全指輪×2）
    ...
    if (!deepStorySeen) {
        await showStoryPages([
            [
                ...
                "guilty of killing your former comrades.",
                "",
                "あなたは　追われる身となった",
                "かつての仲間を　殺した罪で"
            ],
            [
                "Fleeing from your pursuers,",
                "you reached the ruins of the collapsed dungeon.",
                "",
                "追っ手から　逃れるうちに",
                "崩壊したダンジョンの　跡地へ来ていた"
            ],
            [
                "A deep, dark hole gaped before you.",
                "To flee from your sins, you leapt in.",
                "",
                "深く暗い穴がある",
                "あなたは　罪から逃れるために　飛びこんだ"
            ],
            [
                "Falling, endlessly,",
...
window.addEventListener('keydown', async e => {
    ...
    if (e.key === 'ArrowUp' || e.key === 'w') {
        ...
        if (gameState === 'TITLE') {
            ...
            { const _duU = localStorage.getItem('deep_unlocked') === '1'; const _baseU = _duU ? 3 : 2; const count = testModeVisible ? _baseU + 3 : _baseU; titleSelection = (titleSelection + count - 1) % count; }
            SOUNDS.SELECT(); return;
        }
    ...
    if (e.key === 'ArrowDown' || e.key === 's') {
        ...
        if (gameState === 'TITLE') {
            ...
            { const _duD2 = localStorage.getItem('deep_unlocked') === '1'; const _baseD2 = _duD2 ? 3 : 2; const count = testModeVisible ? _baseD2 + 3 : _baseD2; titleSelection = (titleSelection + 1) % count; }
            SOUNDS.SELECT(); return;
        }
            ...
            if (ringEquipPhase === 'SLOT') {
                ...
                if (chosen === null) {
                    ...
                    if (player.equippedRings[otherSlot] === chosen.id) {
                        addLog(`Slot ${ringSlotSelection + 1} にも ${chosen.nameJa} を装備！★二重装備の効果発動★`);
                    } else {
